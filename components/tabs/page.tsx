...
export function TabsDemo() {
  const tabs = [
    
    {
      ...
      value: "career_paths",
      content: (
        <div className="w-[90%] h-[90%] flex justify-center items-center overflow-hidden relative rounded-2xl p-5 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-700 to-violet-900">
  ...
  return (
    <div className="h-[20rem] md:h-[40rem] [perspective:800px] relative b flex flex-col max-w-5xl mx-auto w-full items-start justify-start my-10">
      <Tabs tabs={tabs} />
    </div>
  );
}
